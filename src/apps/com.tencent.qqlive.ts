      ...
      rules: [
        ...
        },
        {
          ...
          matches:
            ...
            'TextView[text.length=4 || text.length=5] <2 View[childCount=2][clickable=true] + View[clickable=true]',
        ...
        },
        {
          ...
          matches:
            ...
            'TextView[text.length=4] < [childCount=2] + ImageView[clickable=true]',
          snapshotUrls: [
