  ...
  groups: [
    {
      ...
      rules: [
        // 第一段
        {
          ...
          name: '第一段 点击朋友圈广告',
          matches:
            '@LinearLayout[clickable=true && left>850] <<3 LinearLayout - ImageView[desc!=null] < LinearLayout[childCount=2]',
        ...
        // 第二，三段
        {
          ...
          name: '第二，三段 点击[关闭广告]',
          anyMatches: [
            '@*[clickable=true && index<=2] <<(3,4,6) * - ImageView[text=null] < LinearLayout[childCount=2]',
          ],
          snapshotUrls: [
